      ...
      return (
        <div>
          ...
          <div className="App">
            ...
            <ProjectCard title="SongLyricsGenerator" descrip="I developed an algorithm that uses Markov Chains to generate original song lyrics in the style of an existing artist." link="https://raghavapamula.com/SongLyricsGenerator/"><img className="image" src={require("./songlyricsgenerator.png")} /></ProjectCard>
          </div>
        </div>
      );
    } else {
        ...
        return (
          <div>
            ...
            <ProjectCard title="Portal.js" descrip="I Developed a 2D platform game developed in ES6 JavaScript where the player destroys and avoids being hit by heat-seeking missiles. Use the Arrow Keys to move and the Mouse to shoot! You can play the full version by clicking the link below. (Warning! Game is not meant to run on mobile browsers)" link="http://raghavapamula.com/portal.js/"><img className="image" src={require("./portal.png")} /></ProjectCard>
            <ProjectCard title="SongLyricsGenerator" descrip="I developed an algorithm that uses Markov Chains to generate original song lyrics in the style of an existing artist." link="https://raghavapamula.com/SongLyricsGenerator/"><img className="image" src={require("./songlyricsgenerator.png")} /></ProjectCard>
          </div>
        );
    }
